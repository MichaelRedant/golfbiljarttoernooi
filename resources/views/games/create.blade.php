...
@section('content')
<div class="container">
    <h1 class="mb-4"><i class="fas fa-calendar-plus"></i> Wedstrijd Aanmaken</h1>
    <form action="{{ route('games.store') }}" method="POST">
        ...
        <div class="card mb-4">
            <div class="card-body">
                ...
                <div class="form-group mb-3">
                    <label for="date"><i class="fas fa-calendar-day"></i> Datum:</label>
                ...
                <div class="form-group mb-3" id="awayTeamGroup">
                    <label for="away_team_id"><i class="fas fa-users"></i> Uit Team:</label>
